package com.qhm.example.test.date;
...
public class DateUtil {
    ...
    public static boolean compareDate_New(String s, String e) {
        if ((fomatDate(s) == null) || (fomatDate(e) == null)) {
            return false;
        }
        return fomatDate(s).getTime() > fomatDate(e).getTime();
    ...
    public static String getYYmmDDDate(Date date) {
        return sdfDay.format(date);
    }
    ...
    public static String GetMinuteBack(Date date, int minute) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static int getTimesub(Date minDate, Date maxDate) {
        String fromDate = simpleFormat.format(minDate);
        String toDate = simpleFormat.format(maxDate);
        try {
    ...
    public static Long getTimeStampByDay(Integer day) {
        String pastDate = getAfterDayDate(day);
        try {
            Date date = sdfDay.parse(pastDate);
